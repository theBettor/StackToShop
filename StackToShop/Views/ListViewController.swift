...
final class ListViewController: UIViewController {
    ...
    let viewModel: WantToBuyListViewModel
    ...
    init(viewModel: WantToBuyListViewModel) {
    ...
    func setupTableView() {
        ...
        tableView.register(MyTableViewCell.self, forCellReuseIdentifier: "WantToBuyCell")
    }
...
extension ListViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "WantToBuyCell", for: indexPath) as! MyTableViewCell
        
        // MVC에서는 멤버 전달⭐️
        // cell.member = memberListManager[indexPath.row]
        
        // MVVM에서는 뷰모델 전달 ⭐️⭐️⭐️
        let wtbVM = viewModel.wtbViewModelAtIndex(indexPath.row)
        cell.viewModel = wtbVM
